...
export class FilterPostsDto extends PaginateDto {
    @IsOptional()
    @IsString()
    @ApiProperty({
        description: 'Post Comma-separated type (e.g., page, post, cpt)',
        type: String,
        required: false,
        example: "post, top_university"
    })
    type?: string;
    ...
    @IsString()
    @ApiProperty({
        description: `Excludes 'Comma-separated type (e.g., 67fe0090a4d8ec876322b8df, 67fdfbff10b086e4baffc423)`,
        type: String,
        required: false,
    ...
    @IsString()
    @ApiProperty({
        description: `Includes 'Comma-separated type (e.g., 67fe0090a4d8ec876322b8df, 67fdfbff10b086e4baffc423)`,
        type: String,
        required: false,
        example: "67fe0090a4d8ec876322b8df, 67fdfbff10b086e4baffc423",
    })
    ...
    @IsString()
    @ApiProperty({
        description: 'Comma-separated tag numbers (e.g., 1, 2, ...)',
        type: String,
        required: false,
        example: "1,2",
    })
    @Matches(/^(\d+,)*\d+$/, { message: 'tag must be a comma-separated list of numbers' })
    tag?: string;
